                ...
                <div class="card">
                    <div class="card-body" id="cardBody" >   
                        ...
                        <div class="kop-surat">
                            ...
                            <div>
                                <h1>LAPORAN HASIL PERFORMANCE ASSESSMENT DIVISI</h1>
                            ...
                            <div class="col-md-6">
                                @if($namaDiv)
                                    <div class="col-12 mb-2">
                                        <div class="d-flex">
                                            <label for="Nama" class="form-label"><b>Nama Organisasi</b></label>
                                            <label style="margin-left: 60px;">:</label>
                                            <span style="margin-left: 10px;">{{ $namaDiv['Organisasi'] }}</span>
                                        </div>
                                    </div>

                                    <div class="col-12 mb-2">
                                        <div class="d-flex">
                                            <label for="Nama" class="form-label"><b>Nama Divisi</b></label>
                                            <label style="margin-left: 100px;">:</label>
                                            <span style="margin-left: 10px;">{{ $namaDiv['Nama'] }}</span>
                                        </div>
                                    </div>
                                @else
                                    <p>No Record Found!</p>
                                ...
                                @foreach($aspekNames as $aspek)
                                    <tr>
                                        ...
                                        @php
                                            ...
                                            // untuk nilai 10 agar persentase menjadi 100%
                                            if ($nilai == 10) {
                                                $percentage = 100;
                                            }
...
@endsection
            ...
            <script>
                function generatePDF() {
                    ...
                    const options = {
                        filename: 'Laporan_Penilaian_Divisi.pdf', // Set the filename
