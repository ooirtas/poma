                ...
                <div class="col-lg-4 offset-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('auth.login_pengurus_action') }}" method="POST">
                                @csrf
                                <div class="col-12">
                                    <label for="inputName" class="form-label">Nim <span
                                            style="color:red">* @error('Nim') {{ $message }} @enderror</span></label>
                                    <input type="text" class="form-control" id="Nim" name="Nim">
                                </div>
                                <div class="col-12">
                                    <label for="inputPassword" class="form-label">Password <span
                                            style="color:red">* @error('Password') {{ $message }} @enderror</span></label>
                            ...
                            <span>Belum Memiliki Akun? <a href="{{ route('auth.register') }}">Klik
                                    disini.</a></span><br>
                            <span>Login Admin <a href="{{ route('logins.index') }}">Klik
                                    disini.</a></span>
